...
var symbolicNames = [null, "Function", "Input", "Local", "If", "Then",
    ...
    "Range", "ComponentObject", "Boolean", "Number", "Quote",
    "TrippleQuote", "Identifier", "Comment", "Space",
    "EOL"];
...
gapParser.Number = 50;
gapParser.Quote = 51;
gapParser.TrippleQuote = 52;
gapParser.Identifier = 53;
...
gapParser.prototype.block = function () {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << gapParser.Function) | (1 << gapParser.If) | (1 << gapParser.Return) | (1 << gapParser.For) | (1 << gapParser.While) | (1 << gapParser.Do) | (1 << gapParser.Repeat) | (1 << gapParser.Not) | (1 << gapParser.Minus))) !== 0) || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (gapParser.OBracket - 36)) | (1 << (gapParser.OParen - 36)) | (1 << (gapParser.Boolean - 36)) | (1 << (gapParser.Number - 36)) | (1 << (gapParser.Quote - 36)) | (1 << (gapParser.TrippleQuote - 36)) | (1 << (gapParser.Identifier - 36)))) !== 0));
    } catch (re) {
        if (re instanceof antlr4.error.RecognitionException) {
            localctx.exception = re;
            this._errHandler.reportError(this, re);
...
gapParser.prototype.functionDecl = function () {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << gapParser.Function) | (1 << gapParser.Local) | (1 << gapParser.If) | (1 << gapParser.Return) | (1 << gapParser.For) | (1 << gapParser.While) | (1 << gapParser.Do) | (1 << gapParser.Repeat) | (1 << gapParser.Not) | (1 << gapParser.Minus))) !== 0) || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (gapParser.OBracket - 36)) | (1 << (gapParser.OParen - 36)) | (1 << (gapParser.Boolean - 36)) | (1 << (gapParser.Number - 36)) | (1 << (gapParser.Quote - 36)) | (1 << (gapParser.TrippleQuote - 36)) | (1 << (gapParser.Identifier - 36)))) !== 0));
        this.state = 82;
...
gapParser.prototype.doStatement = function () {
    ...
    try {
        ...
        this.state = 86;
        _la = this._input.LA(1);
        if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << gapParser.Function) | (1 << gapParser.If) | (1 << gapParser.Return) | (1 << gapParser.For) | (1 << gapParser.While) | (1 << gapParser.Do) | (1 << gapParser.Repeat) | (1 << gapParser.Not) | (1 << gapParser.Minus))) !== 0) || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (gapParser.OBracket - 36)) | (1 << (gapParser.OParen - 36)) | (1 << (gapParser.Boolean - 36)) | (1 << (gapParser.Number - 36)) | (1 << (gapParser.Quote - 36)) | (1 << (gapParser.TrippleQuote - 36)) | (1 << (gapParser.Identifier - 36)))) !== 0)) {
            this.state = 85;
            this.block();
        }
        ...
        switch (la_) {
            ...
            case 11:
                ...
                if (la_ === 1) {
                    ...
                    this.state = 183;
                    _la = this._input.LA(1);
                    if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << gapParser.Function) | (1 << gapParser.Return) | (1 << gapParser.Not) | (1 << gapParser.Minus))) !== 0) || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (gapParser.OBracket - 36)) | (1 << (gapParser.OParen - 36)) | (1 << (gapParser.Boolean - 36)) | (1 << (gapParser.Number - 36)) | (1 << (gapParser.Quote - 36)) | (1 << (gapParser.Identifier - 36)))) !== 0)) {
                        this.state = 182;
                        this.exprList();
                    }
