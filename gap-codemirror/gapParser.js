...
function ListEvaluationExpressionContext(parser, ctx) {
    ExpressionContext.call(this, parser);
    ExpressionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

ListEvaluationExpressionContext.prototype = Object.create(ExpressionContext.prototype);
ListEvaluationExpressionContext.prototype.constructor = ListEvaluationExpressionContext;

gapParser.ListEvaluationExpressionContext = ListEvaluationExpressionContext;

ListEvaluationExpressionContext.prototype.listEvaluation = function () {
...
TupleExpressionContext.prototype = Object.create(ExpressionContext.prototype);
TupleExpressionContext.prototype.constructor = TupleExpressionContext;

gapParser.TupleExpressionContext = TupleExpressionContext;

TupleExpressionContext.prototype.tuple = function () {
...
gapParser.prototype.expression = function (_p) {
    ...
    try {
        ...
        switch (la_) {
            ...
            case 7:
                localctx = new ListEvaluationExpressionContext(this, localctx);
                this._ctx = localctx;
                _prevctx = localctx;
                this.state = 176;
                this.listEvaluation();
